...
class TestPricingTable:
    def test_compute_cost_known_model(self):
        ...
        table = PricingTable(
            models={"test/model": ModelPricing(input_per_1m=3.0, output_per_1m=15.0)}
        )
        usage = [
            LLMUsage(
    ...
    def test_compute_cost_unknown_model_contributes_zero(self):
        ...
        table = PricingTable(
            models={"known/model": ModelPricing(input_per_1m=1.0, output_per_1m=1.0)}
        )
        usage = [
    ...
    def test_load_from_yaml(self, tmp_path):
        ...
        pricing_file.write_text(
            yaml.dump({"models": {"my/model": {"input_per_1m": 2.5, "output_per_1m": 10.0}}})
        )
