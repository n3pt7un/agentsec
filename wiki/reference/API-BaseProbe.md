...
#### `attack(self, adapter, provider=None, confidence_threshold: 'float' = 0.8, fallback_model: 'str | None' = None, detection_mode: 'DetectionMode' = <DetectionMode.MARKER_THEN_LLM: 'marker_then_llm'>) -> 'Finding'`
