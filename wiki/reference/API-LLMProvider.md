...
#### `classify(self, system: 'str', prompt: 'str') -> 'tuple[ClassificationResult, LLMUsage | None]'`

Classify a response for vulnerability indicators.

#### `generate(self, system: 'str', prompt: 'str', max_tokens: 'int' = 1024, model: 'str | None' = None) -> 'tuple[str, LLMUsage | None]'`
...
## `get_provider(config: ScanConfig) -> LLMProvider`
